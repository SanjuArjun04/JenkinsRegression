...
import org.openqa.selenium.support.PageFactory;
		...
		public class HotelSearch extends Utility {
			...
			public void searchhotel(String location, String hotelname )
			{
				
				dropdown(getDdloc(),location);
				dropdown(getDdhotel(),hotelname);
               klik(getSubmitbtn());
			}
			
			public void hSearch(String location,String hotelname) {
				fill(getDdloc(),location);
				fill(getDdhotel(),hotelname);
			klik(getSubmitbtn());
